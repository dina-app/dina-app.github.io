...
- [ ] The homepage card still says **Release candidate · 0.1.0** while the Store item is published at 0.4.3. Decide what it should read before the next deploy — this is the page Google's reviewer lands on.
